...
class BankMyDataControllerTest {
  ...
  class GetAccounts {
    ...
    void success() throws Exception {
      given(bankMyDataService.getAccounts(anyLong()))
          .willReturn(
              List.of(
      ...
      mockMvc
          .perform(get("/mydata/v1/bank/accounts").header("X-User-Id", 1L))
  ...
  class GetAccountDetail {
    ...
    void success() throws Exception {
      given(bankMyDataService.getAccountDetail(anyLong(), anyLong()))
          .willReturn(
      ...
      mockMvc
          .perform(get("/mydata/v1/bank/accounts/1001").header("X-User-Id", 1L))
          .andExpect(status().isOk())
          .andExpect(jsonPath("$.success").value(true))
  ...
  class GetBalance {
    ...
    void success() throws Exception {
      given(bankMyDataService.getBalance(anyLong(), anyLong()))
          .willReturn(
      ...
      mockMvc
          .perform(get("/mydata/v1/bank/accounts/1001/balance").header("X-User-Id", 1L))
          .andExpect(status().isOk())
          .andExpect(jsonPath("$.success").value(true))
          .andExpect(jsonPath("$.data.accountId").value(1001))
          .andExpect(jsonPath("$.data.balance").value(3500000))
  ...
  class GetTransactions {
    ...
    void success() throws Exception {
      given(bankMyDataService.getTransactions(anyLong(), anyLong(), any()))
          .willReturn(
              List.of(
    ...
    void missingHeader_returns400() throws Exception {
      mockMvc
          .perform(get("/mydata/v1/bank/accounts/1001/transactions"))
          .andExpect(status().isBadRequest())
          .andExpect(jsonPath("$.success").value(false))
          .andExpect(jsonPath("$.error.code").value("VALID_001"));
    }
  ...
  class GetTransactionCategories {
    ...
    void success() throws Exception {
      given(bankMyDataService.getTransactionCategories(anyLong(), anyLong()))
          .willReturn(
              List.of(
      ...
      mockMvc
          .perform(
              get("/mydata/v1/bank/accounts/1001/transactions/categories").header("X-User-Id", 1L))
          .andExpect(status().isOk())
          .andExpect(jsonPath("$.success").value(true))
